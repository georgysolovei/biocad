...
├── Dockerfile           # Multi-stage, multi-arch OCI image
...
- [Docker](https://docs.docker.com/get-docker/) (with BuildKit / buildx)
...
```bash
# Build
docker build -t biocad-hello:latest .

# Run
docker run -p 32777:32777 biocad-hello:latest
...
docker buildx build \
  ...
  -t <your-registry>/biocad-hello:latest \
  --push \
  .
```
...
kubectl port-forward svc/biocad-hello 32777:32777
# Open http://localhost:32777 in your browser
---
